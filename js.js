...
function createEditIcon(book) {
  ...
  editIcon.src = "/icons/pencil-svgrepo-com.svg";
...
function createBookItem(book, index) {
  ...
  bookItem.appendChild(
    createBookElement("h1", `By: ${book.author}`, "book-author")
  );
  bookItem.appendChild(
    createBookElement("h1", `Number of pages: ${book.pages}`, "book-pages")
  );
  bookItem.appendChild(createReadElement(bookItem, book));
  bookItem.appendChild(createBookElement("button", "X", "delete"));
  bookItem.appendChild(createEditIcon(book));
  // Create the div for project icons
  const projectIcons = document.createElement("div");
  projectIcons.setAttribute("class", "project-icons");
  
  // Create and append the <i> elements for the icons
  ...
  bookItem.appendChild(projectIcons);
